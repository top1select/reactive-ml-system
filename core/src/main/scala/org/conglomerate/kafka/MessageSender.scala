...
object MessageSender {
  ...
  private val BATCHSIZE = "1024" // Buffers for unsent records for each partition - controls batching
  private val LINGERTIME = "1" // Timeout for more records to arrive - controls batching
