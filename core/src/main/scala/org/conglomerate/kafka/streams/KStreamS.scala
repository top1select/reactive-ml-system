...
//    inner.mapValues[VR](mapper(_))
  ...
  def flatMapValues[VR](f: V => Iterable[VR]): KStreamS[K, VR] = {
//    inner.flatMapValues[VR]((v: V) => processor(v).asJava)
    inner.flatMapValues[VR](new ValueMapper[V, JIterable[VR]] {
...
//          transformerS.punctuate(tiemstamp) match {
